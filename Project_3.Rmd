...
*The chart above displays the distribution between the Inflight Wifi Service Rating and the corresponding number of people who were satisfied/unsatisfied. As expected, as the rating for inflight wifi service increases, so does the number of people who are satisfied. Interestingly, the number of people who are neutral or dissatisfied is very similar if the rating is 2 or 3, which is in line with the mean inflight wifi service rating as calculated above. Further, it is a surprise that all of the customers who gave a 0 rating for inflight wifi service were all satisfied, according to the chart.*
...
*As we can see in the result above, the accuracy for this model is 87.38%.* 
