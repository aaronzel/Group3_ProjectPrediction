...
summary(is.na(airline_train))
#na.omit(airline_train$Arrival.Delay.in.Minutes  )
mean(airline_train$Arrival.Delay.in.Minutes)
...
#building SVM model
airline_train2 <- airline_train[1:10,]
svm_model1 <- ksvm(as.factor(satisfaction) ~., data = airline_train2, kernel = "vanilladot", scaled = TRUE)
svm_model1
...
caret::confusionMatrix(as.factor(predictions_svm), as.factor(airline_test$satisfaction))
#fix NA values to get this
sum(is.na(airline_test$satisfaction))
