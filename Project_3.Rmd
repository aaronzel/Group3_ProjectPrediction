...
decision_accuracy <- (14242 + 10715)/25976
decision_sensitivity <- (10715/11403)
decision_specificity <- (14242/14573)
decision_precision <- (10715/11046)

#Summary

Model_name <- "Decision Tree"

decision_metrics <- data.frame(Model_name, decision_accuracy, decision_sensitivity, decision_specificity, decision_precision)
decision_metrics
```
