...
*The 1st combined model is based on a simple voting system. If 4 or more models predict satisfied (1), then the combined model predicts satisfied. This leads to an accuracy of 92%, sensitivity of 88%, and Kappa of 0.83, making it a relatively good model. Next, we will look at an ensemble method.*
<br />
<br />
