...
ggplot(airline_train,
       aes(x = Inflight.wifi.service,
           fill = as.factor(satisfaction))) +
  geom_bar(position = "dodge") + 
  labs(y = "Number Satisfied", x = "Inflight Wifi Service Rating", title = "Inflight Wifi Service Rating vs Number Satisfied")
```
...
ggplot(airline_train,
       aes(x = Ease.of.Online.booking,
           fill = as.factor(satisfaction))) +
  geom_bar(position = "dodge") +
  labs(y = "Number Satisfied", x = "Ease of Online Booking Rating", title = "Ease of Online Booking vs Number Satisfied")
```
...
ggplot(airline_train,
       aes(x = Gate.location,
           fill = as.factor(satisfaction)))+
  geom_bar(position = "dodge")+
  labs(y = "Number Satisfied", x = "Gate Location Rating", title = "Gate Location Rating vs Number Satisfied")
```
