...
ggplot(airline_train,
  ...
  labs(y = "Number Satisfied", x = "Inflight Wifi Service Rating", fill = "Satisfaction", title = "Inflight Wifi Service Rating vs Number Satisfied")
```
...
ggplot(airline_train,
       aes(x = Ease.of.Online.booking,
           ...
           labels = c("Neutral or Dissatisfied", "Satisfied")))) +
  geom_bar(position = "dodge") +
  labs(y = "Number Satisfied", x = "Ease of Online Booking Rating", fill = "satisfaction", title = "Ease of Online Booking vs Number Satisfied")
```
...
ggplot(airline_train,
       aes(x = Gate.location,
           ...
           labels = c("Neutral or Dissatisfied", "Satisfied")))) +
  geom_bar(position = "dodge")+
  labs(y = "Number Satisfied", x = "Gate Location Rating", fill = "satisfaction", title = "Gate Location Rating vs Number Satisfied")
```
